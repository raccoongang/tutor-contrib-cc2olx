...
from cc2olx_plugin.utils.filesystem import ensure_directory_exists
...
def cc2olx(context: click.Context) -> None:
    ...
    _ensure_output_dir_exists(args)
...
def _ensure_output_dir_exists(args: List[str]) -> None:
    """
...
def _run_cc2olx_converter(command: List[str]) -> None:
    ...
    click.echo('\033[96mThe converter output:\033[0m')
    try:
